...
CREATE UNIQUE INDEX acc_id ON entries(account_id);

CREATE UNIQUE INDEX from_acc_id ON transfers(from_account_id);

CREATE UNIQUE INDEX to_acc_id ON transfers(to_account_id);

CREATE UNIQUE INDEX both_acc_id ON transfers(from_account_id, to_account_id);
